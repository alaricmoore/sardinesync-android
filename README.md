...
- Wraps your sardine-track site in a WebView, so logging in and browsing your data feels like one app.
...
- **Server address** — your sardine-track URL, e.g. `https://your-tracker.example.com`
...
You need the Android SDK and a **JDK 17–21**.
...
```bash
git clone https://github.com/alaricmoore/sardinessync-android.git
cd sardinessync-android
./gradlew :app:assembleDebug
# -> app/build/outputs/apk/debug/app-debug.apk
```

Install the APK on a phone with Health Connect (built in on Android 14+; a Play Store install on 11–13), open it, and fill in the setup screen.

## License

GNU Affero General Public License v3.0 (AGPL-3.0), matching sardine-track. Free for individuals and non-profits with attribution; commercial use requires a separate license.
